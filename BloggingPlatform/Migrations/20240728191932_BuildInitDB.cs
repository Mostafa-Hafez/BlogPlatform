...
{
    /// <inheritdoc />
    public partial class BuildInitDB : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    com_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    com_text = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Com_time = table.Column<DateTime>(type: "datetime2", nullable: false),
